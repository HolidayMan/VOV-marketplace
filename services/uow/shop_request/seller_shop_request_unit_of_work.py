...
from repositories.seller_shop_request_repository.mysql_seller_shop_request_repository \
    import MySQLAsyncSellerShopRequestRepository
from repositories.seller_shop_request_repository.seller_shop_request_repository \
    import AsyncSellerShopRequestRepository
from services.unit_of_work import MySQLAsyncUnitOfWork, AsyncUnitOfWork


class AbstractSellerShopRequestUnitOfWork(AsyncUnitOfWork, ABC):
